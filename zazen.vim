...
hi LineNr       guifg=#880000          guibg=NONE      gui=NONE
hi Statement    guifg=#a6a6a6          guibg=NONE      gui=bold
hi Function     guifg=#800000          guibg=NONE      gui=bold
hi String       guifg=#838383          guibg=NONE      gui=NONE
hi Type         guifg=#eeeeee          guibg=NONE      gui=bold
hi Conditional  guifg=#800000          guibg=NONE      gui=bold
...
if &t_Co > 255
   ...
   hi  Function           ctermfg=160        ctermbg=NONE       cterm=none
   ...
   hi  Constant           ctermfg=244        ctermbg=0        cterm=none
   ...
   hi  Pmenu              ctermfg=160        ctermbg=232        cterm=NONE
   hi  PmenuSbar          ctermfg=160        ctermbg=233        cterm=NONE
   hi  PmenuThumb         ctermfg=160         ctermbg=233        cterm=NONE
   ...
   hi  StatusLine         ctermfg=255        ctermbg=124        cterm=bold
   hi  StatusLineNC       ctermfg=255        ctermbg=124        cterm=NONE
   hi  TabLine            ctermfg=255         ctermbg=124        cterm=underline
   hi  TabLineFill        ctermfg=255         ctermbg=124         cterm=reverse
   hi  TabLineSel         ctermfg=255         ctermbg=124         cterm=bold
